        ...
        <article>
          ...
          <section class="full-width background-dark">
            <div class="s-12 m-12 l-6">
              ...
              <div style="background-image: url(<?php echo asset('Estilos/img/Fondo.jpeg'); ?>);" class="contact-image" ></div>
            </div>
...
<?php echo $__env->make('Plantillas.Base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Huawei\resources\views/Empresa/Contactanos.blade.php ENDPATH**/ ?>