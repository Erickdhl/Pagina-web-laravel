...
<script type="text/javascript" src="<?php echo asset('Estilos/js/responsee.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('Estilos/js/jquery.events.touch.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('Estilos/owl-carousel/owl.carousel.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('Estilos/js/template-scripts.js'); ?>"></script> 
</body>
</html><?php /**PATH C:\xampp\htdocs\Huawei\resources\views/Plantillas/Pie.blade.php ENDPATH**/ ?>