        ...
        <div class="line">
          <div class="margin">  
            <div class="s-12 m-12 l-0 margin-m-bottom">
              ...
              <a class="margin-bottom" ><img src="<?php echo asset('Estilos/img/I.png'); ?>" alt=""></a>
              <p class="text-size-16 text-dark"></p>
            </div>
            <div class="s-12 m-12 l-0 margin-m-bottom">
                <h2>II. Fidelizar y captar nuevos clientes</h2>
                <a class="margin-bottom" ><img src="<?php echo asset('Estilos/img/II.png'); ?>" alt=""></a>
                <p class="text-size-16 text-dark"></p>    
            </div>
            <div class="s-12 m-12 l-0 margin-m-bottom">
                <h2>III. Incrementar el desempeño y el grado de satisfacción de los trabajadores</h2>
                <a class="margin-bottom" ><img src="<?php echo asset('Estilos/img/III.png'); ?>" alt=""></a>
                <p class="text-size-16 text-dark"></p>   
            </div>
            <div class="s-12 m-12 l-0 margin-m-bottom">
                <h2>IV. Desarrollo, investigación e innovación de nuevas tecnologías</h2>
                <a class="margin-bottom" ><img src="<?php echo asset('Estilos/img/IV.png'); ?>" alt=""></a>
                <p class="text-size-16 text-dark"></p>            
            </div>
         </div>
        </div>
...
<?php echo $__env->make('Plantillas.Base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Huawei\resources\views/Empresa/PlanEstrategico.blade.php ENDPATH**/ ?>